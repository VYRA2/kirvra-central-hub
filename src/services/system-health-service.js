...
export class SystemHealthService {
     ...
     */
    static async getSystemHealthSnapshot() {
    ...
    static async checkDatabase(client) {
    ...
    static async checkStorage(client) {
        const start = Date.now();
        if (!client) {
            return {
                id: "storage",
    ...
    static async checkRealtime(client) {
        if (!client) {
            return {
                id: "realtime",
    ...
    static async runSystemDiagnostic() {
